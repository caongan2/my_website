<article  id="post-<?php the_ID(); ?>"  <?php post_class("col-12 col-md-6 content-index"); ?>>
	<div class="content-index-inner">
		...
		<div class="post-content">
			...
			<div class="button-container text-right">
				<a class="btn btn-read-more" href="<?php the_permalink(); ?>"><?php esc_html_e('Read More', 'fastshop-ecommerce'); ?></a>
			</div>
